...
WebUI.scrollToElement(findTestObject('Product Page/1 - Products/View Product - Blue Top'), 5)
...
WebUI.setEncryptedText(findTestObject('Detailed Data Register Page/Input New Passsword'), 'tE+PEiSUqqgo23gg3D+W7A==')

WebUI.setText(findTestObject('Detailed Data Register Page/Input First Name'), 'budi')

WebUI.setText(findTestObject('Detailed Data Register Page/Input Last Name'), 'harto')

WebUI.setText(findTestObject('Detailed Data Register Page/Input Address'), 'Jl. Jalan')

WebUI.setText(findTestObject('Detailed Data Register Page/Input State'), 'Mumbai')

WebUI.setText(findTestObject('Detailed Data Register Page/Input City'), 'Delhi')

WebUI.setText(findTestObject('Detailed Data Register Page/Input Zipcode'), '123456')

WebUI.setText(findTestObject('Detailed Data Register Page/Input Phone'), '081234567890')
...
WebUI.setText(findTestObject('Detailed Payment Page/Field Card Number'), '123')

WebUI.setText(findTestObject('Detailed Payment Page/Field CVV'), '333')
