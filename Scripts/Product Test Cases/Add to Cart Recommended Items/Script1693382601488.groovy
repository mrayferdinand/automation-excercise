...
WebUI.scrollToElement(findTestObject('Home Page/Recommendation Section/h2_recommended items'), 5)

WebUI.delay(5)

WebUI.click(findTestObject('Home Page/Recommendation Section/A'))
