...
WebUI.click(findTestObject('Checkout Page/Products/Delete - Blue Top'))

WebUI.verifyElementVisible(findTestObject('Checkout Page/Cart is Empty'), FailureHandling.STOP_ON_FAILURE)
