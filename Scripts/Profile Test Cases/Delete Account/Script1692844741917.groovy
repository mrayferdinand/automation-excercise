...
WebUI.setText(findTestObject('Signup and Login Page/Login Section/Input Email'), 'budi123@gmail.com')

WebUI.setEncryptedText(findTestObject('Signup and Login Page/Login Section/Input Password'), 'tE+PEiSUqqgo23gg3D+W7A==')
